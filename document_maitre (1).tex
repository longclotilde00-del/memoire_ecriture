...
\medskip
	...
	\input{chapitres/skinsoft.tex}
	\input{chapitres/s_movies.tex}
	\input{chapitres/problematique.tex}
	
	\input{chapitres/notions_indexation.tex}
	\input{{chapitres/analyse_automatique.tex}}
	\input{chapitres/indexation_automatique.tex}
	\input{chapitres/indexation_iconographique.tex}
	\input{chapitres/indexation_audio.tex}
	
	\input{chapitres/IA_generale.tex}
	\input{chapitres/machine_learning.tex}
	\input{chapitres/computer_vision.tex}
	\input{chapitres/IA_video.tex}
	\input{chapitres/segmentation.tex}
	
	\input{chapitres/limites_critiques.tex}
	
	\input{chapitres/archives_audiovisuelles.tex}
	\input{chapitres/notions_NLP.tex}
	\input{chapitres/experience_utilisateur.tex}
