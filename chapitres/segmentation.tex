...
Enfin, elle peut désigner la segmentation de la bande sonore d'une image animée, on parlera alors de segmentation audio, par exemple entre des paroles et de la musique. \footcite{carrive2014}
...
Les grandes familles de modèles de vidéo semantic segmentation :
...
"La première étape du processus d’analyse des documents audiovisuels est bien souvent une étape de segmentation temporelle qui consiste à identifier dans le document des séquences possédant des caractéristiques communes ou des ruptures entre ces séquences."\footcite{carrive2014}
