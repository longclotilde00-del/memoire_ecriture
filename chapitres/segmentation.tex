...
Consiste à segmenter l'image en groupes de pixels selon certains critères. 

\item Segmentation vidéo

Définition : "Video segmentation—partitioning video frames into multiple segments or objects" \footcite{zhou2022}
