...
les composants de la vision par ordinateur ont été mis en place en partie pour l'analyse d'images et la détection d'objets dans l'image. \footcite{norindr2023}
...
Etapes d'entraînement d'un modèle : "prévoir un jeu de données initial, et d’évaluer les performances du modèle après ce premier entraînement. À partir	de ces résultats, il devient possible d’adapter les jeux de données suivants, pour pallier	aux faiblesses constatées." \footcite{norindr2023}
